...
export default function ProductsList({ products }) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col p-4 w-full my-2">
        <label 
        ...
        <input
          id="searchInput"
          className="form-control py-2 px-4 rounded shadow w-full md:w-max-content"
          type="text"
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-4 h-full py-10">
